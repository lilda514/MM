...
class OrderIdGenerator(ABC):
    ...
    @abstractmethod
    def decode(self, orderId: Union[str,int]) ->  Union[str,int]:
        """
        Decode the order id to something that can be used to match the level it belongs to 
